...
_See code: [src/commands/org/create/agent-user.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/create/agent-user.ts)_
...
_See code: [src/commands/org/create/sandbox.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/create/sandbox.ts)_
...
_See code: [src/commands/org/create/scratch.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/create/scratch.ts)_
...
_See code: [src/commands/org/delete/sandbox.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/delete/sandbox.ts)_
...
_See code: [src/commands/org/delete/scratch.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/delete/scratch.ts)_
...
_See code: [src/commands/org/disable/tracking.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/disable/tracking.ts)_
...
_See code: [src/commands/org/display.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/display.ts)_
...
_See code: [src/commands/org/enable/tracking.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/enable/tracking.ts)_
...
_See code: [src/commands/org/list.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/list.ts)_
...
_See code: [src/commands/org/list/metadata.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/list/metadata.ts)_
...
_See code: [src/commands/org/list/metadata-types.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/list/metadata-types.ts)_
...
_See code: [src/commands/org/open.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/open.ts)_
...
_See code: [src/commands/org/open/agent.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/open/agent.ts)_
...
_See code: [src/commands/org/open/authoring-bundle.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/open/authoring-bundle.ts)_
...
_See code: [src/commands/org/refresh/sandbox.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/refresh/sandbox.ts)_
...
_See code: [src/commands/org/resume/sandbox.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/resume/sandbox.ts)_
...
_See code: [src/commands/org/resume/scratch.ts](https://github.com/salesforcecli/plugin-org/blob/5.10.7/src/commands/org/resume/scratch.ts)_
